...
class ReadFile{
   public:
        ...
        MainStation get_first_Station();
        //funzione che ritorna l'ultima stazione
        MainStation get_last_Station();

        //funzioni che ritornano liste aggiustate
        std::list<Station*> get_station_list();
        std::list<Train*> get_train_list();
        //funzione che restituisce lista di stazioni principali
        std::list<Station*> get_main_station_list();

        //funzioni che restituisco la stazione dopo ricevento come un parametro Station
